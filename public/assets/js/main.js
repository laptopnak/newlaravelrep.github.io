...
function customizer() {
    ...
    $cusHtml += '<li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#sidebar-setting">Sidebar</a></li>';
    $cusHtml += '<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#header-setting">Header</a></li>';
    $cusHtml += '<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#primary-setting">Primary</a></li>';
    $cusHtml += '</ul>';
